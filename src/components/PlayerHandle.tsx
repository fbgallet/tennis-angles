 ...
 */
export function getPlayerArmTheta({orientation, handedness, swing}: {orientation: CourtOrientation, handedness: 'left'|'right', swing: 'forehand'|'backhand'}): number {
...
export const PlayerHandle: React.FC<Omit<PlayerHandleProps, 'ctx'>> = () => null; // Placeholder for future overlay refactor
